...
public class Constraint
{
	...
	public Constraint(Map<String, String> attrs)
	{
		this.attributes = new HashMap<>();
		this.attributes.putAll(attrs);
	}

	public void addSelector(Map<String, String> selector)
	{
		this.attributes.putAll(selector);
	}

	public void addField(Map<String, String> field)
	{
		this.attributes.putAll(field);
	}
}
