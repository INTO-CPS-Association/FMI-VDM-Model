...
The FMI2 static semantic model and the FMI2_to_VDM tool are packaged in the release to create a stand-alone tool for verifying FMU files, called VDMCheck2. This can be used to check existing FMI version 2 FMU files against the standard.
